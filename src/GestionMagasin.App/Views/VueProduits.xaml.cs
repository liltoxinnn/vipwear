...
/// <summary>Catalogue des produits et de leurs déclinaisons.</summary>
public partial class VueProduits : UserControl
{
    public VueProduits() => InitializeComponent();
    ...
    {
        if (e.Key != Key.Enter || DataContext is not VueModeleProduits vueModele)
        {
            return;
        }
